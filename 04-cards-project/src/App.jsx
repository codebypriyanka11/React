...
import { Bookmark as Book } from 'lucide-react'
...
const App = () => {
  const jobOpenings = [
    ...
    {
      brandLogo: "https://images.icon-icons.com/2642/PNG/512/google_logo_g_logo_icon_159348.png",
      companyName: "Google",
  ...
  return (
    <div className='parent'>
      {jobOpenings.map(function(elem,idx){
        console.log(idx);
return <div key={idx}>
  <Card key={idx} logo={elem.brandLogo} company={elem.companyName} datePosted={elem.datePosted} post={elem.post} tag1={elem.tag1} tag2={elem.tag2} pay={elem.pay} location={elem.location} />
</div>
