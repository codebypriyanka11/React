...
let printUserData = <h3 className="text-gray-700 text-xs absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">loading... </h3>
...
{printUserData}
      ...
      <div className=" flex justify-center  gap-6 items-center p-4">
        ...
        className='bg-amber-400 text-white text-sm curser-pointer active:scale-95 rounded px-4 py-2 '
        onClick={() => {
